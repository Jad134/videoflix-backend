...
SECRET_KEY = 'django-insecure-&e7xqka=5epoxk12dn#q$mcagh+t=_5iwx9qcr)l-umf(_q%$_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['jad-el-nader.developerakademie.org']
...
DATABASES = {
   'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'dasdasdas',
        'HOST': 'localhost',  # oder die IP-Adresse des Datenbankservers
