...
from users.views import ActivateAccountView, CheckUsernameView, PasswordResetFormView, PasswordResetRequestView, PasswordResetSubmitView,  UserLoginView, UserRegistrationView, ResendActivationLinkView
